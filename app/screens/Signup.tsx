    ...
    <View className='h-screen  bg-blue-600'>
          <View className='h-60 items-center justify-center bg-blue-600'>
            <View className='size-25 items-center justify-center bg-white rounded-full'>
              <Image source={logo} resizeMode='contain' className='w-15 h-15 mr-2' />
            </View>
          </View>
          ...
          <View className='flex-1 bg-slate-100 rounded-t-4xl pt-7'>
            <View>
              <View className="mx-auto w-fit ">
                <View className='flex-row text-center'>
                  ...
                  <Text className="text-4xl font-extrabold  text-yellow-400">up</Text>
                </View>
            ...
            <View className=' p-5 px-10 gap-4 mt-6'>
                ...
                {formik.touched.name && formik.errors.name ? (
                  <Text className='text-red-500 text-xs mt-1 ml-4'>{formik.errors.name}</Text>
                ) : null}
              </View>
              ...
              <View>
                ...
                {formik.touched.email && formik.errors.email ? (
                  <Text className='text-red-500 text-xs mt-1 ml-4'>{formik.errors.email}</Text>
                ) : null}
              </View>
              ...
              <View>
                ...
                {formik.touched.password && formik.errors.password ? (
                  <Text className='text-red-500 text-xs mt-1 ml-4'>{formik.errors.password}</Text>
                ) : null}
              </View>
              ...
              <View className='flex-row justify-center items-center mt-2 gap-1'>
                ...
                <Link
                  ...
                  >
                    <Text className="text-blue-600 font-medium hover:underline">login</Text>
                  </Link>
              </View>
            </View>
          </View>
